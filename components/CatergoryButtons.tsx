...
import destinationCatergories from "@/data/categories";
...
const CatergoryButtons = ({onCategoryChanged}:Props) => {
  ...
  const handleSelectCategory = (index: number) => {
    ...
    onCategoryChanged(destinationCatergories[index].title)
  };
  ...
  return (
    <View>
      ...
      >
        {destinationCatergories.map((item, index) => (
          <TouchableOpacity
            key={index}
